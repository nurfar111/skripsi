...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="index.php?halaman=ubahproduk&id=<?= $pecah['id_produk']; ?>"
                    class="btn btn-warning btn-xs">ubah</a> |
                <a href="index.php?halaman=detailproduk&id=<?= $pecah['id_produk']; ?>"
                    class="btn btn-info btn-xs">detail</a> |
                <a href="index.php?halaman=hapusproduk&id=<?= $pecah['id_produk']; ?>"
