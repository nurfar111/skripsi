	...
	<div class="col-md-8">
		<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<textarea type="text" name="deskripsi" class="form-control" rows="6" required></textarea>
				</div>
				<div class="form-group">
					<label>Foto</label>
...
if(isset($_POST["submit"])){
	...
	if($result AND $hasil){
		...
		echo "<script>alert('Data gagal ditambahkan');window.location='index.php?halaman=produk';</script>";
	}
}
?>
